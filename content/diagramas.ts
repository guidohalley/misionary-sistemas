...
export const FENIX: Diagram = {
  ...
  nodes: [
    {
      ...
      kind: "actor",
      label: "Misionary",
      stack: "equipo de carga y gestión",
    ...
    },
    {
      ...
      kind: "ext",
      label: "Portal Tokko",
      stack: "Tokko Broker · catálogo inmobiliario",
      desktop: { col: 1, row: 0 },
      mobile: { col: 1, row: 0 },
    },
    {
  ...
  routes: [
    ...
    { id: "operacion", label: "De la consulta a la comisión", edges: ["e5", "e7", "e8", "e9"] },
    { id: "gestion", label: "Nosotros cargamos los datos", edges: ["e1", "e6", "e9"] },
  ],
}
...
export const FATIMA: Diagram = {
  ...
  nodes: [
    ...
    { id: "api", kind: "api", label: "Lógica del sistema", stack: "API · NestJS · Prisma", desktop: { col: 2, row: 0 }, mobile: { col: 0, row: 1, span: 2 } },
    { id: "pg", kind: "data", label: "Base de datos", stack: "PostgreSQL", desktop: { col: 3, row: 0 }, mobile: { col: 0, row: 2 } },
    { id: "admin", kind: "actor", label: "Administración", desktop: { col: 0, row: 1 }, mobile: null },
    {
      id: "panel",
      kind: "app",
      label: "Panel de gestión",
      stack: "panel web de administración",
  ...
  routes: [
    ...
    { id: "gestion", label: "Gestión diaria", edges: ["c", "d", "e"] },
  ],
}
...
export const GYM: Diagram = {
  ...
  nodes: [
    ...
    { id: "api", kind: "api", label: "Lógica del sistema", stack: "API · Express · Prisma", desktop: { col: 2, row: 0 }, mobile: { col: 0, row: 1, span: 2 } },
    { id: "pg", kind: "data", label: "Base de datos", stack: "PostgreSQL", desktop: { col: 3, row: 0 }, mobile: { col: 0, row: 2 } },
  ...
  routes: [
    { id: "rutina", label: "La rutina llega a la pantalla", edges: ["a", "b", "c", "d", "f"] },
...
export const PROCESO: Diagram = {
  ...
  lanes: [
    { label: "Tu empresa", row: 0 },
    { label: "Nuestro equipo", row: 1 },
  ...
  nodes: [
    ...
    { id: "soporte", kind: "step", label: "Soporte continuo", desktop: { col: 4, row: 1 }, mobile: null },
    {
      ...
      kind: "ext",
      label: "CRM interno",
      stack: "Twenty · self-hosted",
      detalle: ["Seguimiento de clientes de Misionary"],
      desktop: { col: 0, row: 2 },
      mobile: null,
    },
    {
  ...
  edges: [
    ...
    { id: "h6", from: "dev", to: "deploy", kind: "data", label: "publicación" },
  ...
  routes: [
    {
      id: "entrega",
      label: "De la primera charla al sistema en uso",
